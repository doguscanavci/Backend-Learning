...
public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    // İ harfini I'ya dönüştürerek alfabetik sıralamada S harfinin önüne geçmesini sağlıyoruz
    String QUESTION_6 = "SELECT * FROM ogrenci ORDER BY REPLACE(ad, 'İ', 'I') ASC";
    ...
    String QUESTION_10 = "SELECT * FROM ogrenci WHERE LOWER(ad) LIKE '_e%'";
